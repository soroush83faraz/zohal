...
import 'package:zohal/theme.dart';
import 'package:zohal/controllers/card_controller.dart';
import 'dart:async';
import 'package:zohal/theme_notifier.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ThemeProvider(
      initTheme:
          themeNotifier.themeMode == ThemeMode.light ? lightTheme : darkTheme,
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    ThemeSwitcher.
                    of(context).changeTheme(
                      theme: themeNotifier.themeMode == ThemeMode.light
                          ? lightTheme
                          : darkTheme,
                    );
                  },
